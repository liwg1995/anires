...
从事：运维攻城狮、python爬虫攻城狮、python Web攻城狮、pythoner
...
技术及语言
----
  - Python: Flask、Django、Scrapy、Pyspider
  - DB: SQLServer, MySQL, MongoDB, PostgreSQL, Clickhouse
  - WebServer: nginx
  - OS: Ubuntu, CentOS, MacOS, Windows
  - Others: Docker, git, saltstack
  - Web: Jenkins, gitlab, sentry, satis, zabbix

工作经历
----

1. 乐视云计算科技有限公司（现新乐视云联）
2. 北京壹合互动科技有限公司

链接
----

* [GitHub](https://github.com/liwg1995)
* [技术博客](https://olei.me)
